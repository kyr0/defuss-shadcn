...
**70 components — 27 with JavaScript, 43 CSS-only — 70.4 KiB minified + compressed.**
43 of 70 components need no JavaScript — native HTML and modern CSS cover them entirely.
